...
- When you finish work for an issue, save progress with `index.js completed --issue [number] --title "[short description of what you did]" --description "[multi-line description of what you did]"`. This also closes the issue.
...
4. Work on the issue
5. When you finish working, use `index.js completed --issue [number] --title "[short description of what you did]" --description "[multi-line description of what you did]"`
