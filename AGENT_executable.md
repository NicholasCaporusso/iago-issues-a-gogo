...
- When you discover missing follow-up work, create a new issue with `iago report --title "[title]" --description "[description]" --label "[bug|improvement|feature] --relay"`.
...
6. If you identify new issues, use `iago report --title "[title]" --description "[multi-line description]" --label "[bug|improvement|feature] --relay"`
7. Restart from 1. Never go to 8 from here.
8. Identify improvements and report them with `iago report --title "[title]" --description "[multi-line description]" --label "[bug|improvement|feature] --relay"`
9. You are done
