...
- Source: [`src/server/server.js`](/workspace/tools-github-issues-resolver/src/server/server.js)
- Default vault file: [`src/server/vault/repos.json`](/workspace/tools-github-issues-resolver/src/server/vault/repos.json)
...
The relay vault lives at `src/server/vault/repos.json` by default.
...
The server reuses the shared Git and GitHub helpers from [`src/shared/repository.js`](/workspace/tools-github-issues-resolver/src/shared/repository.js).
