...
- Source: [`src/cli/cli.js`](/workspace/tools-github-issues-resolver/src/cli/cli.js)
...
```bash
github-issues-resolver completed --issue 42 --files src/cli/cli.js --title "Fix CLI help"
```
...
The CLI implementation shares repository and GitHub helpers from [`src/shared/repository.js`](/workspace/tools-github-issues-resolver/src/shared/repository.js).
